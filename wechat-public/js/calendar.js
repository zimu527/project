...
$.fn.extend({ProgressBarWars: function(opciones) {
		...
		//if(opciones.color!=''){
	//			StringStyle="<style>.color"+styleUnique+"{ border-radius: 10px;display: block; width: 0%; box-shadow:0px 0px 10px 1px "+opciones.color+", 0 0 1px "+opciones.color+", 0 0 1px "+opciones.color+", 0 0 1px "+opciones.color+", 0 0 1px "+opciones.color+", 0 0 1px "+opciones.color+", 0 0 1px "+opciones.color+";background-color: #F4B573;}</style>";
	//			opciones.estilo="color"+styleUnique;
	//		}
		//$(ProgressBarWars).before(StringStyle);
		$(".barContro_space").append('<span class="contiue" style="height: '+opciones.alto+';"  id="bar'+theidProgressBarWars+'"></span>');
